...
function shouldBeColored(elem) {
	...
	console.log("main: elem.URL = " + elem.url);
	console.log("main: elem.type = " + elem.type + " elem.totalSize = " + typeof(elem.totalSize));
	...
	if (isGoodBook) {
		console.log("main: should be colored");
		console.log("main: because bookPageMinSize = " + typeof(storage.properties.bookPageMinSize));
	} 
